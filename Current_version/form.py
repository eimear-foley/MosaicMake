        ...
        <body>
                ...
                <div id="header-wrapper" style="height: 35%;">
                        <div id="header" class="container">
                                <div id="logo">
                                        <h1 style=" color: white;"> <img src="../jigsaw.png" alt="jigsaw piece" height="25" width="25">  Mosai$
                                </div>
                                <div id="menu">
                                        <ul>
                ...
                <div id="wrapper" style='padding-top: 1em; padding-bottom: 2em;'>
                        ...
                        <div class="container" style='border: 1px solid black; border-radius: .5em; padding: 1em; font-size: 17px;'>
                                <form action="loading.py" method="get">
                                        ...
                                        <br><br><label for="myTags" style='padding-bottom: .5em;'>Choose by tag which type of images will make$
                                        <br><br />
                                        <ul id="myTags">
                ...
                <div id="copyright" class="container">
                        <p>&copy; MosaicMake. All rights reserved. | released under the <a href="http://templated.co/license">Creative Commons$
                </div>
        </body>
</html>
""")
